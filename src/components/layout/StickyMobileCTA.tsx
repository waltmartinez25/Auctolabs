...
import { CALENDLY_URL, CTA_BOOK, CTA_AUDIT } from '@/lib/constants';
...
export const StickyMobileCTA = () => {
  ...
  return (
    ...
    >
      <div className="bg-card/95 backdrop-blur-sm border-t border-border/40 px-4 py-3 shadow-xl flex gap-3"
